import pandas as pd
import numpy as np
data_file = 'file://localhost/C:/workspace_python/firstgraph/data_output/edge_tag.csv'
...
data_quality_report
print("\nFirst Data Quality Report- Tag-Tag Relationen/ Edges")
print("\nDataFrame Shape")
print(df.shape)
print("\nDataFrame Info")
print(df.info())
...
print("\nData Quality Report - Tag Nodes -after removing missing values")
