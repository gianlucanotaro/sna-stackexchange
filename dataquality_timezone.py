import pandas as pd
import numpy as np
data_file = 'file://localhost/C:/workspace_python/firstgraph/data_output/node_timezone.csv'
...
data_quality_report
print("\nFirst Data Quality Report- Timezone Nodes")
print("\nDataFrame Shape")
print(df.shape)
print("\nDataFrame Info")
print(df.info())
...
print("\nData Quality Report - Timezone Nodes -after removing missing values")
